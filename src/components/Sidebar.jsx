...
export default function Sidebar() {
  return (
    <aside className="sidebar">
      <img
        src={`https://api.dicebear.com/9.x/initials/svg?seed=${contactInfo.name}&backgroundColor=2d2438&textColor=9d7cd8&fontSize=40`}
      ...
      <div className="sidebar-info">
        ...
        <div>
          ...
          <div className="sidebar-info-value">{contactInfo.shortLocation}</div>
        </div>
      </div>
